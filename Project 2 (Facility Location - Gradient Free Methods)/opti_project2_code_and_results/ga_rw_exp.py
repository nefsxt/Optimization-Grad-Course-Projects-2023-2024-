...
for n in [50,100,200]:
    filename1 = "C:\\Users\\Nefeli\\Desktop\\opti_project2\\ga_rw_results\\vecs_ga_rw_N_"+str(n)+".txt"
    filename2 = "C:\\Users\\Nefeli\\Desktop\\opti_project2\\ga_rw_results\\sol_ga_rw_N_"+str(n)+".txt"
    with open(filename1, 'w+') as file1, open(filename2, 'w+') as file2:
   
        for i in range(0,25):
            #print(i)
            results = ga.ga_roulette_main([0.0,1.0],n,57,2,n,0.5,0.2,0.25)
