...
#for n in [200]:
for n in [50,100]:
    filename1 = "C:\\Users\\Nefeli\\Desktop\\opti_project2\\pso_gbest_results\\vecs_pso_gbest_N_"+str(n)+".txt"
    filename2 = "C:\\Users\\Nefeli\\Desktop\\opti_project2\\pso_gbest_results\\sol_pso_gbest_N_"+str(n)+".txt"
    with open(filename1, 'w+') as file1, open(filename2, 'w+') as file2:
   
        for i in range(0,25):
            #print(i)
            results = pso.pso_main([0.0,1.0], n, 57, 0.729, 2.05,2.05,0.005,0)
